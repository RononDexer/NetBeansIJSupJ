...
public class ThreePointCircularROI_ implements PlugIn {
    ...
    public void run(String arg) {
        ...
        if (circ[2] > 0) {
            ...
            double cx = circ[0] - circ[2], cy = circ[1] - circ[2];
            roiManager.addRoi( new OvalRoi( ( int )cx, ( int )cy, (int) (circ[2] * 2), (int) (circ[2] * 2) ) );
            double vx = p2[0] - cx, vy = p2[1] - cy;
            double tmp = vy;
            vx = -vy;
            vy = tmp;
            double x1 = p2[0] + 2 * vx, y1 = p2[1] + 2 * vy;
            double x2 = p2[0] - 2 * vx, y2 = p2[1] - 2 * vy;
            roiManager.addRoi( new Line( ( int )x1, ( int )y1, ( int )x2, ( int )y2 ) );
        }
    }
